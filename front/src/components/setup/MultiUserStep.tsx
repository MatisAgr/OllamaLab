...
export default function MultiUserStep({ config, onConfigChange, onNext, onPrevious, isFirstStep }: SetupStepProps) {
  ...
  return (
    <div className="space-y-8">
      <div className="text-center">
        ...
        >
          Configure if multiple users can access this instance
        </motion.p>
      </div>
        ...
        {config.multiUser?.enabled && (
          ...
          >
            <div>
              ...
              <input
                type="password"
                value={config.multiUser.adminPassword || ''}
                onChange={(e) => handleMultiUserChange('adminPassword', e.target.value)}
            ...
            <div>
              ...
              <input
                type="number"
                value={config.multiUser.maxUsers || 10}
                onChange={(e) => handleMultiUserChange('maxUsers', parseInt(e.target.value))}
                className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                min="1"
                max="100"
              />
